...
colors = [
	...
	["#3b4252", "#3b4252"],  # 0 background option 2
    ["#2e3440", "#2e3440"],  # 1 background option 2
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), size=35,  opacity=1.0,bottom=bar.Gap(18),left=bar.Gap(18),right=bar.Gap(18), margin=[8,20,0,20])),
